...
import com.gic.itc.tourest.MainActivity;
import com.gic.itc.tourest.R;
import com.gic.itc.tourest.adapter.NavigationDrawerAdapter;
import com.gic.itc.tourest.helper.SessionManager;
import com.gic.itc.tourest.model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profile = (ImageButton) layout.findViewById(R.id.profilePhoto);
        profile.setOnClickListener(this);
        logout = (TextView) layout.findViewById(R.id.txtLogout);
        logout.setOnClickListener(this);

        pref = new SessionManager(getActivity());
